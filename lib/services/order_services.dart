    ...
    return Container(
      ...
      child: TextButton(
        ...
        onPressed: () {
          if (document['cod'] == true) {
            return showMyDialog(
                'Recive Payment', 'Delivered', document.id, context);
          }
          EasyLoading.show();
          _services
              .updateStatus(id: document.id, status: 'On the way')
              .then((value) {
            EasyLoading.showSuccess('Order Status is now on th way');
          });
        },
      ),
    );
    ...
    showCupertinoDialog(
        ...
        builder: (BuildContext context) {
          return CupertinoAlertDialog(
            title: Text(title),
            content: Text('Make sure you have recieved the payment'),
            actions: [
              ElevatedButton(
                onPressed: () {
                  EasyLoading.show();
                  _services.updateStatus(id: documentId, status: 'Delivered');
                  EasyLoading.showSuccess('Order status is on Delivered');
